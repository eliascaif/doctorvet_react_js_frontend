...
const EditOwner = (props) => {
    ...
    useEffect(()=>{
        ...
        setData({...props.data, id_veterinaria: props.id_vet, token: props.token});
    },[])
            ...
            <div className='header-title'>
                <div className='controls-new-owner'>
                    ...
                    <span style={{marginLeft:'1em'}}>
                        ...
                        <span className='owner-header-subtitle'>Editando propietario</span>
                    </span>
                </div>
